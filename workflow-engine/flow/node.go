...
type Node struct {
	...
	NodeID         string          `json:"nodeId,omitempty"`         // 当前节点id
	PrevID         string          `json:"prevId,omitempty"`         // 当前节点的父节点id
	ChildNode      *Node           `json:"childNode,omitempty"`      // 当前节点的下一个节点（子节点）
...
var ActionConditionTypes = [...]string{
	RANGE: "dingtalk_actioner_range_condition",
	VALUE: "dingtalk_actioner_value_condition",
}
